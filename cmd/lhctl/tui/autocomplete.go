...
var AvailableSlashCommands = []SlashCommandDef{
	...
	{"/add-dir", "Add directory to workspace (/add-dir <path>)"},
	{"/remove-dir", "Remove directory from workspace (/remove-dir <path>)"},
	{"/dirs", "List attached workspaces (alias: /workspaces)"},
	{"/dir", "Manage workspace directories (add, remove, list)"},
	{"/voice", "Toggle voice dictation (or press F5 / Ctrl+R)"},
	{"/speak", "Speak last assistant response aloud (or /speak auto)"},
