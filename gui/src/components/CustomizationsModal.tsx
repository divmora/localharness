          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#262626] bg-[#000000] shrink-0">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-semibold text-[#F9FAFB]">Customizations Manager</h2>
              </div>
            ...
            <div className="flex flex-1 overflow-hidden">
              {/* Sidebar Tabs */}
              <div className="w-48 bg-[#0A0A0A] border-r border-[#262626] flex flex-col p-2 gap-1 shrink-0">
                {tabs.map(tab => (
                  <button
                    key={tab.id}
