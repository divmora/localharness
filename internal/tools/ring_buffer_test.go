...
func TestRingBufferOverflow(t *testing.T) {
	...
	_, _ = rb.Write([]byte("abcdefghijklmno")) // 15 bytes into 10-byte buffer
...
func TestRingBufferWrapAround(t *testing.T) {
	...
	_, _ = rb.Write([]byte("12345678")) // 8 bytes
...
func TestRingBufferLargeOverflow(t *testing.T) {
	...
	_, _ = rb.Write([]byte("first-pass-data"))
	_, _ = rb.Write([]byte("second-pass-data-here"))
