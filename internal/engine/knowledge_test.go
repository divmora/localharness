...
func TestKnowledgeStore_WriteUpdatesMetadata(t *testing.T) {
	...
	// First write
	_ = ks.WriteArtifact("test-ki", "Initial summary", "file1.md", "content1", nil)
	...
	_ = ks.WriteArtifact("test-ki", "Updated summary", "file2.md", "content2", []string{"ref.go"})
...
func TestKnowledgeStore_ReplaceInArtifact(t *testing.T) {
	...
	_ = ks.WriteArtifact("test-ki", "Test", "doc.md", "Hello world, this is a test.", nil)
...
func TestKnowledgeStore_ReplaceNotFound(t *testing.T) {
	...
	_ = ks.WriteArtifact("test-ki", "Test", "doc.md", "Hello world", nil)
...
func TestKnowledgeStore_Delete(t *testing.T) {
	...
	_ = ks.WriteArtifact("doomed-ki", "Will be deleted", "doc.md", "content", nil)
...
func TestKnowledgeStore_DeleteArtifact(t *testing.T) {
	...
	_ = ks.WriteArtifact("test-ki", "Test", "file1.md", "content1", nil)
	_ = ks.WriteArtifact("test-ki", "", "file2.md", "content2", nil)
...
func TestKnowledgeStore_DeleteLastArtifact(t *testing.T) {
	...
	_ = ks.WriteArtifact("test-ki", "Test", "only-file.md", "content", nil)
...
func TestKnowledgeStore_List_Sorted(t *testing.T) {
	...
	_ = ks.WriteArtifact("zebra-ki", "Z", "doc.md", "z", nil)
	_ = ks.WriteArtifact("alpha-ki", "A", "doc.md", "a", nil)
	_ = ks.WriteArtifact("middle-ki", "M", "doc.md", "m", nil)
...
func TestKnowledgeStore_ConcurrentAccess(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		go func(n int) {
			...
			_ = ks.WriteArtifact(name, "Summary", "doc.md", "content", nil)
			ks.List()
			ks.Get(name)
		}(i)
	}
...
func TestKnowledgeStore_Staleness(t *testing.T) {
	...
	_ = os.MkdirAll(filepath.Dir(refPath), 0755)
	_ = os.WriteFile(refPath, []byte("package engine"), 0644)

	// Create KI referencing that file
	_ = ks.WriteArtifact("test-ki", "Test", "doc.md", "content", []string{"internal/engine/engine.go"})
	...
	time.Sleep(10 * time.Millisecond)
	_ = os.WriteFile(refPath, []byte("package engine // modified"), 0644)
...
func TestKnowledgeStore_Staleness_AfterUpdate(t *testing.T) {
	...
	_ = os.WriteFile(refPath, []byte("package ref"), 0644)

	_ = ks.WriteArtifact("test-ki", "Test", "doc.md", "old", []string{"ref.go"})

	// Make it stale
	time.Sleep(10 * time.Millisecond)
	_ = os.WriteFile(refPath, []byte("package ref // changed"), 0644)
	ks.CheckStaleness([]string{wsDir})
	...
	_ = ks.WriteArtifact("test-ki", "Updated", "doc.md", "new", []string{"ref.go"})
	ki, _ = ks.Get("test-ki")
	if ki.Stale {
...
func TestKnowledgeStore_Staleness_MissingRef(t *testing.T) {
	...
	_ = ks.WriteArtifact("test-ki", "Test", "doc.md", "content", []string{"nonexistent.go"})
